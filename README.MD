...
1. Clone the repository:
  ...
  ```
2. Make sure you have the correct Visual Studio packages needed for .NET 4.7.2 development with c# in Windows Forms
3. Open the project in **Visual Studio 2019 or later**.  
